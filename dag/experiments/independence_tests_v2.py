## CONTROLLARE, POTREBBERO ESSERCI ERRORI
...
from dag.experiments.do_calculus_v2 import DEFAULT_DAG
    ...
    for assertion in independencies.get_assertions():
        for x in assertion.event1:
            for y in assertion.event2:
                ...
                cond_values = assertion.event3 if assertion.event3 is not None else []
